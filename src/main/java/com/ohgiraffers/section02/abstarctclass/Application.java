...
public class Application {
    public static void main(String[] args) {
        ...
        /*수업목표. 초상클래스와 추상메소드에 대해 이해할 수 있다.*/
        /*필기.
        *  추상클래스와 추상메소드
        ...
        *    */
        ...
        /*필기.
        *  추상 클래스에 작성한 추상메소드는 "반드시" 후손이 오버라이딩 해서 작성해야 하며,
        *  추상 클래스에 작성한 메소드를 호출하게 되면 실제 후손 타입의 인스턴스가 가지는
        *  메소드는 다형성이 적용되서 동적 바인딩에 의해 다양한 응답을 할 수 있다.
        *  */
        ...
        *  */
        ...
        //Product 추상 클래스는 인스턴스를 생성할 수 없다.
...
//        추상 클래스 본인이 가지고 있는 메소드 호출
        ...
        *  따라서 여러 클래스들을 그룹화 하여
        *  필수 기능!!! 을 정의하여 강제성을 부여해 개발시 일관되게 만들 수 있다.*/
