...
public class Application01 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*필기.
        *  다형성이란, 객제지향 프로그래밍의 3대 특징 (캡슐화, 상속, 다형성) 중 하나이며,
...
//        호랑이 t1 = new 동물();
        ...
        *  런타입(프로그램 실행) 당시 실제 객체가 가진 오버라이딩 된 메소드를 바인딩 바뀌어서 동작하는 것을 의미
        * */
        ...
        /*필기. 하지만 현재 레퍼런스 변수 a1, a2 라는 타입이 현재 동물이기 때문에
...
//        ((호랑이)a1).물어뜯기();     토끼는 호랑이가 될 수 없다. runtimeException 번역은 문제가 없지만, 프로그램 동작시 오류발생
        ...
        *   */
        ...
        System.out.println("a1이 동물 타입인지 확인 = " + (a1 instanceof 동물)); //이것이 다형성이다.
        System.out.println("a1이 Object 타입인지 확인 = " + (a1 instanceof Object)); // 얽혀있다
        ...
        * */
        ...
        /*목차. 9. 클래스의 업캐스티와 다운캐스팅 확인*/
        /*필기.
        *   클래스의 형변환은 up-casting 과 down-casting 으로 구분할 수 있다.
...
//        토끼 r3 = a3;  down- casting 묵시적 형변환은 안됨 / 동물이 더 큰 타입이라 들어가지 않는다.
